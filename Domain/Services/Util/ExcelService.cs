...
namespace Domain.Services.Util
{
    public class ExcelService : IExcelService
    {
        ...
        public byte[] GenerateRiskRegisterXml(Guid projectId)
        {
        ...
        public byte[] GenerateStakeholderRegisterXml(Guid projectId, string projectName)
        {
        ...
        private void SetCellStyle(IXLCell cell, string value, bool doWrap = false, bool isBold = false, XLColor color = null)
        {
            cell.Value = value;
