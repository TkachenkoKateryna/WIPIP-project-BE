...
namespace Persistence.Migrations
{
    ...
    [Migration("20220601105023_Update user")]
            ...
            modelBuilder.Entity("Domain.Models.Entities.Deliverable", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = new Guid("340cf520-35e7-47f3-ad61-5e15d705cb6f"),
                            TimeOfComplition = new DateTime(2022, 6, 15, 10, 50, 21, 889, DateTimeKind.Utc).AddTicks(4561),
                            Title = "Project Plan"
                        },
                        new
                        {
                            ...
                            ProjectId = new Guid("340cf520-35e7-47f3-ad61-5e15d705cb6f"),
                            TimeOfComplition = new DateTime(2022, 12, 18, 10, 50, 21, 889, DateTimeKind.Utc).AddTicks(4575),
                        ...
                        new
                        {
                            ...
                            IsDeleted = false,
                            ProjectId = new Guid("340cf520-35e7-47f3-ad61-5e15d705cb6f"),
                            TimeOfComplition = new DateTime(2022, 12, 18, 10, 50, 21, 889, DateTimeKind.Utc).AddTicks(4580),
            ...
            modelBuilder.Entity("Domain.Models.Entities.EmployeeSkill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4fac52cd-e383-46a4-9867-3da57615390b"),
                        ...
                        new
                        {
                            Id = new Guid("cfceda83-a9ea-4757-a688-a8595ecc1049"),
                        ...
                        new
                        {
                            Id = new Guid("72e29ad7-00c1-41c4-b56d-0299a7afbc1c"),
                            EmployeeId = new Guid("39ca7391-d752-402e-8ef6-0b255ebefa7f"),
                            IsDeleted = false,
                            Primary = true,
                            Proficiency = 3,
                        ...
                        new
                        {
                            Id = new Guid("51940fc5-f423-4d64-98ee-a550937b39fe"),
            ...
            modelBuilder.Entity("Domain.Models.Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6964a661-e6bf-463d-8123-eaed80275735",
                            Email = "bob@test.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "BOB@TEXT.COM",
                            NormalizedUserName = "BOB",
                            PasswordHash = "AQAAAAEAACcQAAAAECdXZRZ4PQGP8rBpvyXgpOPDPXejbkeJATrDsQfxWkoQPCKEhm+RltW4poZBjPz4sw==",
                            PhoneNumberConfirmed = false,
                            RoleId = "967e08ad-b71e-46e8-8e80-ffdce9ab9e74",
                            SecurityStamp = "c526f89a-abc1-4f8c-8639-7dd4c54f1e6e",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d17b5091-b38a-48f4-94e2-55cdce4d20a0",
                            Email = "jane@test.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "JANE@TEXT.COM",
                            NormalizedUserName = "JANE",
                            PasswordHash = "AQAAAAEAACcQAAAAEMWVk+DRfrNCgQQT7bAwWsw7+/mAapzZ21pi9kqQTCnHn0Q73RtxwR3aAkUHuvLY1w==",
                            PhoneNumberConfirmed = false,
                            RoleId = "09afe919-59ff-44b8-b656-c5e320c163a7",
                            SecurityStamp = "871e69f0-747b-4bf3-9add-858cb8481a06",
                            TwoFactorEnabled = false,
                            UserName = "jane"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ad281e64-f656-4f9e-8a5d-13534802ee8c",
                            Email = "alla@test.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ALLA@TEST.COM",
                            NormalizedUserName = "ALLA",
                            PasswordHash = "AQAAAAEAACcQAAAAEEt2kZ2xQjnY71L3rABGxXVkGs8j9BuBbKsgsBvmyleTAL68L2z3ibzpDP3xccFHWQ==",
                            PhoneNumberConfirmed = false,
                            RoleId = "27a697ec-3ab1-4c03-9534-d3dd0d797fd6",
                            SecurityStamp = "270f7df2-cc82-47ba-b203-45d1e1dc51a7",
                            TwoFactorEnabled = false,
                            UserName = "alla"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.ProjectRisk", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4bd10284-a4d3-4ab5-93d2-d83a010d365f"),
                            IsDeleted = false,
                            ProjectId = new Guid("340cf520-35e7-47f3-ad61-5e15d705cb6f"),
                        ...
                        new
                        {
                            Id = new Guid("60f7155d-538b-4dcb-af91-4b9b2c0fa313"),
                            IsDeleted = false,
                            ProjectId = new Guid("340cf520-35e7-47f3-ad61-5e15d705cb6f"),
                        ...
                        new
                        {
                            Id = new Guid("dfac0c6f-cf83-4165-ace4-082dca449ee0"),
                            IsDeleted = false,
                            ProjectId = new Guid("340cf520-35e7-47f3-ad61-5e15d705cb6f"),
                        ...
                        new
                        {
                            Id = new Guid("732447e8-8c48-4733-89fc-9eddea6d53e0"),
                            IsDeleted = false,
                            ProjectId = new Guid("340cf520-35e7-47f3-ad61-5e15d705cb6f"),
            ...
            modelBuilder.Entity("Domain.Models.Entities.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "818feba6-2725-4b55-8684-6346d81dd579",
                            Name = "Manager",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b4751275-9a78-40e5-8db2-25f10a566ba1",
                            Name = "Lead",
                            NormalizedName = "LEAD"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "585d828e-6ead-4a3d-ab86-1b8e32e079d7",
                            Name = "Admin",
